...
JNIEXPORT jstring JNICALL Java_com_tencent_liteav_audio_impl_Record_Apm_helloFromHWAPMSDK(JNIEnv *env, jobject /* this */)
{
    std::string hello = "Hello from webrtc!!!";
    return env->NewStringUTF(hello.c_str());
}

JNIEXPORT jboolean JNICALL Java_com_tencent_liteav_audio_impl_Record_Apm_nativeCreateApmInstance
...
JNIEXPORT void JNICALL Java_com_tencent_liteav_audio_impl_Record_Apm_nativeFreeApmInstance
...
JNIEXPORT jint JNICALL Java_com_tencent_liteav_audio_impl_Record_Apm_highPassfilterEnable
...
JNIEXPORT jint JNICALL Java_com_tencent_liteav_audio_impl_Record_Apm_aecEnable
        (JNIEnv *env, jobject thiz, jboolean enable){
...
JNIEXPORT jint JNICALL Java_com_tencent_liteav_audio_impl_Record_Apm_aecClockDriftCompensationEnable
(JNIEnv *env, jobject thiz, jboolean enable){
...
JNIEXPORT jint JNICALL Java_com_tencent_liteav_audio_impl_Record_Apm_aecSetSuppressionLevel
...
JNIEXPORT jint JNICALL Java_com_tencent_liteav_audio_impl_Record_Apm_aecmEnable
        (JNIEnv *env, jobject thiz, jboolean enable){
    LOGV("aecm_enable");
    ApmWrapper *apm = (ApmWrapper*) get_ctx(env, thiz);
...
JNIEXPORT jint JNICALL Java_com_tencent_liteav_audio_impl_Record_Apm_aecmSetSuppressionLevel
        (JNIEnv *env, jobject thiz, jint level){
...
JNIEXPORT jint JNICALL Java_com_tencent_liteav_audio_impl_Record_Apm_nsSetLevel
(JNIEnv *env, jobject thiz, jint level){
...
JNIEXPORT jint JNICALL Java_com_tencent_liteav_audio_impl_Record_Apm_nsEnable
(JNIEnv *env, jobject thiz, jboolean enable){
...
JNIEXPORT jint JNICALL Java_com_tencent_liteav_audio_impl_Record_Apm_agcSetAnalogLevelLimits
...
JNIEXPORT jint JNICALL Java_com_tencent_liteav_audio_impl_Record_Apm_agcSetMode
...
JNIEXPORT jint JNICALL Java_com_tencent_liteav_audio_impl_Record_Apm_agcSetTargetLevelDbfs
  (JNIEnv *env, jobject thiz, jint level){
...
JNIEXPORT jint JNICALL Java_com_tencent_liteav_audio_impl_Record_Apm_agcSetCompressionGainDb
...
JNIEXPORT jint JNICALL Java_com_tencent_liteav_audio_impl_Record_Apm_agcEnableLimiter
        (JNIEnv *env, jobject thiz, jboolean enable){
    ApmWrapper *apm = (ApmWrapper*) get_ctx(env, thiz);
...
JNIEXPORT jint JNICALL Java_com_tencent_liteav_audio_impl_Record_Apm_agcEnable
(JNIEnv *env, jobject thiz, jboolean enable){
...
JNIEXPORT jint JNICALL Java_com_tencent_liteav_audio_impl_Record_Apm_agcSetStreamAnalogLevel
(JNIEnv *env, jobject thiz, jint level){
...
JNIEXPORT jint JNICALL Java_com_tencent_liteav_audio_impl_Record_Apm_agcStreamAnalogLevel
        (JNIEnv *env, jobject thiz){
...
JNIEXPORT jint JNICALL Java_com_tencent_liteav_audio_impl_Record_Apm_vadEnable
(JNIEnv *env, jobject thiz, jboolean enable){
...
JNIEXPORT jint JNICALL Java_com_tencent_liteav_audio_impl_Record_Apm_vadSetLikelihood
...
JNIEXPORT jboolean JNICALL Java_com_tencent_liteav_audio_impl_Record_Apm_vadStreamHasVoice
        (JNIEnv *env, jobject thiz){
...
JNIEXPORT jint JNICALL Java_com_tencent_liteav_audio_impl_Record_Apm_ProcessStream
...
JNIEXPORT jint JNICALL Java_com_tencent_liteav_audio_impl_Record_Apm_ProcessReverseStream
...
JNIEXPORT jint JNICALL Java_com_tencent_liteav_audio_impl_Record_Apm_setStreamDelayMs
...
JNIEXPORT jint JNICALL Java_com_tencent_liteav_audio_impl_Record_Apm_setSampleRateAndChannels
